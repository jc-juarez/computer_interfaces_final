        ...
        case APP_STATE_MAIN_TASK:
            ...
            if(!appData.deviceConfigured) {
                ...
                switch(appData.receiveDataBuffer[0]) {   
                    case 0x01:
                        appData.receiveDataBuffer[1] == 1 ? BSP_LEDOn(APP_USB_LED_1) : BSP_LEDOff(APP_USB_LED_1);
                        appData.hidDataReceived = false;
                        USB_DEVICE_HID_ReportReceive(USB_DEVICE_HID_INDEX_0, &appData.rxTransferHandle, appData.receiveDataBuffer, 64);
                        appData.state = APP_STATE_MAIN_TASK;
                        break;
                    case 0x02:
                        appData.receiveDataBuffer[1] == 1 ? BSP_LEDOn(APP_USB_LED_2) : BSP_LEDOff(APP_USB_LED_2);
                        appData.hidDataReceived = false;
                        USB_DEVICE_HID_ReportReceive(USB_DEVICE_HID_INDEX_0, &appData.rxTransferHandle, appData.receiveDataBuffer, 64);
                        appData.state = APP_STATE_MAIN_TASK;
                        break;
                    case 0x03:
                        appData.receiveDataBuffer[1] == 1 ? BSP_LEDOn(APP_USB_LED_3) : BSP_LEDOff(APP_USB_LED_3);
                        appData.hidDataReceived = false;
                        USB_DEVICE_HID_ReportReceive(USB_DEVICE_HID_INDEX_0, &appData.rxTransferHandle, appData.receiveDataBuffer, 64);
                        appData.state = APP_STATE_MAIN_TASK;
                        break;
                    ...
                    case 0x82:
                        if(appData.hidDataTransmitted){
                            ...
                            appData.transmitDataBuffer[6] = '4';
                            ...
                            appData.transmitDataBuffer[14] = '8';
                            appData.transmitDataBuffer[15] = '2';
                            appData.transmitDataBuffer[16] = '5';
                            appData.transmitDataBuffer[17] = '2';
                            appData.transmitDataBuffer[18] = '3';
                            appData.transmitDataBuffer[19] = '5';
